(function (global, factory) {
  ...
  */
	...
	var hasIdleCallback = window.requestIdleCallback;
  ...
  */
	function config(options) {
		var newScrollThrottle = options.scrollThrottle;
		var newResizeThrottle = options.resizeThrottle;
		var newIdleTimeout = options.idleTimeout;
